...
public class EmailHelper implements Runnable {
	...
	public void run () 
	{
		...
		try
		{
			...
			Session session = Session.getDefaultInstance(lprop, new javax.mail.Authenticator() {  
				protected PasswordAuthentication getPasswordAuthentication() {  
					return new PasswordAuthentication(lEmailConfig.Properties("UserName"),
							EncryptionHelper.Decrypt3Des(lEmailConfig.Properties("Password")));
